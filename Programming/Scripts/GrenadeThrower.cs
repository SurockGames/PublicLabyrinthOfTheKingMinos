...
public class GrenadeThrower : MonoBehaviour
{
    ...
    [SerializeField, Range(1, 10)] private float ExplosionDelay = 5f;
    [SerializeField]
    ...
    private void DrawProjection()
    {
        ...
        Vector3 startVelocity = ThrowStrength * transform.forward / Grenade.mass;
        int i = 0;
    ...
    private void ReleaseGrenade()
    {
        ...
        Grenade.AddForce(transform.forward * ThrowStrength, ForceMode.Impulse);
